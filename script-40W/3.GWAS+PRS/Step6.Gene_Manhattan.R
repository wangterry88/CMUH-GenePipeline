...
cat(prompt="Input Gene based GWAS results (Full directory): ")
cat('Ex: ./GWAS/test.txt.annot')
cat('\n')
GENE_RESULT<-readLines(con="stdin",1)
...
tmp_manhattan_gene=paste0('./GWAS/plot/',PLOT_OUT,'.gene.manhattan.png',collapse = '')
