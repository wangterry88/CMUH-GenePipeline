...
TPMI_list<-fread("./TPMI-list/TPMI-40W-PTID-Name.txt",sep="\t",header=T)
...
tmp_have_chip_GWAS=paste0('./output/',Output_name,'.RAW-pheno-data.txt',collapse = '')
...
tmp_mplot_age=paste0('./output/',Output_name,'.match.age.png',collapse = '')
...
tmp_mplot_sex=paste0('./output/',Output_name,'.match.sex.png',collapse = '')
